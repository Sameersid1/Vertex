...
import { configureMonaco,defaultEditorOptions,getEditorLanguage } from '../lib/editor-config'            //Adds themes, autocomplete, snippets, etc.
...
const  PlaygroundEditor=({
  ...
  useEffect(()=>{
    ...
    if (suggestion && suggestionPosition) {
      ...
      console.log("typeof =", typeof monacoRef.current);
      console.log("languages =", monacoRef.current?.languages);
      const provider = createInlineCompletionProvider(monaco)

      //"Monaco, whenever you need inline completions, use THIS provider."
    ...
    const updateEditorLanguage=()=>{
        ...
        try {
           monacoRef.current.editor.setModelLanguage(model, language);
            ...
            console.log("Failed to set editor language:",error)
        }
    }
    useEffect(()=>{
        updateEditorLanguage()
