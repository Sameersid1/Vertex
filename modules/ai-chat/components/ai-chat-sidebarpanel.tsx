...
export const AIChatSidePanel: React.FC<AIChatSidePanelProps> = ({
  ...
  const getChatModePrompt = (mode: string, content: string) => {
    switch(mode){
        case "review":
            return `Please review this code and provide detailed suggestions for improvement, including performance,
        ...
        case "optimize":
            return `Please analyze this code for performance optimization and suggest improvements:\n\n**Code to optimize:** ${content}`
