...
export async function POST(request:NextRequest){
    try {
        ...
        console.error("Content anlysis error:",error)
...
function buildPrompt(context: CodeContext, suggestionType: string): string {
  return `You are Codellama, an expert software engineer specializing in ${context.language}.

Your task is to generate a ${suggestionType} code completion.
...
- If nothing should be inserted, return an empty response.
